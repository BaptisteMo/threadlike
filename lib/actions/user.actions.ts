...
export async function fetchUsers({ 
    ...
    try {
        ...
        throw new Error (`Erreur pour récupérer les users : ${error.message} `)
    }
}
...
export async function getActivity(userId : string){
    ...
    try{
        ...
        // Find all the child thread ids -> Les réponses depuis le champs 'children' de chaque thread récupéré
        ...
        throw new Error (`Erreur pour récupérer les activités : ${error.message} `)    
